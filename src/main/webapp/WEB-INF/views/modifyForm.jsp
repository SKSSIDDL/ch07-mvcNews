		...
		<form id="modify_form" action="modify.do" method="post">
			...
			<ul>
				<li>
					...
					<input type="text" name="title" id="title" value="${vo.title}" size="30" maxlength="50" class="input-check">				
				</li>
				<li>
					<label for="writer">작성자</label>
					<input type="text" name="writer" id="writer" value="${vo.writer}" size="10" maxlength="10" class="input-check">				
				</li>
				<li>
				...
				<li>
					...
					<input type="email" name="email" id="email" value="${vo.email}" size="30" maxlength="50" class="input-check">				
				</li>
				<li>
